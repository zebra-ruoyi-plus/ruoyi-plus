...
JAVA="java -jar -server -Xms202m -Xmx424m -XX:PermSize=128m -XX:MaxPermSize=128m -XX:+UseConcMarkSweepGC "
#jar\u5305\u540d\u79f0  \u522b\u540d
PROGRAM="zebra-yritsz-api-consumer-2.0.jar zebra consumer"
if [ $1 == "start" ] 
  then   
